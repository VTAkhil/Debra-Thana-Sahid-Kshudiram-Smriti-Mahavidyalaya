                ...
                <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12">
                    <div class="it-breadcrumb-content z-index-1">
                        <div class="it-breadcrumb-title-box">
                            <h3 class="it-breadcrumb-title">ISO</h3>
                        </div>
            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12 wow itfadeLeft" style="visibility: visible; animation-name: itfadeLeft;">
                    ...
                    <div class="it-about-2-section-title-box mb-20">
                        <h2 class="site-title"><span>ISO</span></h2>
                    ...
                    <div class="row">
                        <div class="col-sm-3">
                            <div class="gallery">
                                <a class="fancybox" data-fancybox="gallery" href="Pdf/IQAC/ISO/ISO_9001_2015.jpg">
                                    <img src="Pdf/IQAC/ISO/ISO_9001_2015.jpg">
                                </a>
                                <div class="gallery-title">
                                    <p>ISO 9001:2015</p>
                                    <p><a href="Pdf/IQAC/ISO/ISO_9001_2015.jpg">View</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
