                ...
                <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12">
                    <div class="it-breadcrumb-content z-index-1">
                        <div class="it-breadcrumb-title-box">
                            <h3 class="it-breadcrumb-title">Internal Complaint Committee</h3>
                        </div>
            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12 wow itfadeLeft" style="visibility: visible; animation-name: itfadeLeft;">
                    ...
                    <div class="it-about-2-section-title-box mb-20">
                        <h2 class="site-title">Internal Complaint <span>Committee</span></h2>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr><th>1</th><td><img class="staff" src="../FacultyImage/105.jpg"></td><td>Dr. Rupa Dasgupta</td><td>Principal &amp; Chairperson, Mob-9733846160</td><td><a href="FacultyProfile.aspx?id=105">View Profile</a></td></tr><tr><th>2</th><td><img class="staff" src="../FacultyImage/166.jpg"></td><td>Bipasha Majumder (De)</td><td>Convener</td><td><a href="FacultyProfile.aspx?id=166">View Profile</a></td></tr><tr><th>3</th><td><img class="staff" src="../FacultyImage/61.jpg"></td><td>Dr. Arpita Tripathy</td><td>TS</td><td><a href="FacultyProfile.aspx?id=61">View Profile</a></td></tr><tr><th>4</th><td><img class="staff" src="../FacultyImage/137.jpg"></td><td>Dr. Sanjukta Sahoo</td><td>Members</td><td><a href="FacultyProfile.aspx?id=137">View Profile</a></td></tr><tr><th>5</th><td><img class="staff" src="../FacultyImage/1223.jpg"></td><td>Smt. Anshumita Nanda</td><td>Paschim Medinipur Prativa (NGO)</td><td><a href="FacultyProfile.aspx?id=1223">View Profile</a></td></tr>
                            </tbody>
                        </table>
                    </div>
