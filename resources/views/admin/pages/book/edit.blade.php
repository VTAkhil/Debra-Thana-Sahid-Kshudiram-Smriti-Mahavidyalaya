...
@section('title', 'Edit Faculty Book')
@section('content')
            ...
            <div class="row page-titles mx-0">
                ...
                <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="javascript:void(0);">Add Faculty Book</a></li>
                    </ol>
                </div>
            </div>
            <div class="row">
                <div class="col-xl-12 col-xxl-12 col-sm-12">
                    ...
                    <div class="card">
                        <div class="card-header justify-content-start">
                            <h5 class="card-title me-3">Edit Faculty Book</h5>
                            <a href="{{ url('/vtadmin/list-book') }}" class="btn btn-primary"><i class="fa-solid fa-angles-left"></i> Back</a>
                        </div>
                        <div class="card-body">
                            <form action="{{ url('/vtadmin/editBook', $data->id) }}" method="post" enctype="multipart/form-data"> 
                                @csrf
                                <div class="row">
                                    <div class="col-sm-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-hasicon mb-xl-0 mb-3">
                                                <input type="text" name="author_name" placeholder="Enter Author Name"
                                                    class="form-control" value="{{ $data->author_name }}" required="">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                    ...
                                    @php
                                        $hasFile = !empty($data->book_file);
                                        $hasLink = !empty($data->book_link);
                                    @endphp
                                    <div class="col-sm-4">
                                        <!-- File Upload Box -->
                                        <div class="mb-3" id="fileBox" style="{{ $hasFile ? '' : 'display:none;' }}">
                                            <label class="form-label">Choose File</label>
                                            <input type="file" name="book_file" class="form-control" value="{{ $data->book_file }}">
                                            @php
                                                $ext = strtolower(pathinfo($data->book_file, PATHINFO_EXTENSION));
                                            @endphp
                                            @if (in_array($ext, ['jpg', 'jpeg', 'png', 'webp']))
                                                <img src="{{ url('/public/uploads/book/' . $data->book_file) }}" style="width:80px;height:80px">
                                            @elseif ($ext === 'pdf')
                                                <a href="{{ url('/public/uploads/book/' . $data->book_file) }}" class="btn btn-sm btn-primary" download>
                                        ...
                                        <div class="mb-3" id="linkBox" style="{{ $hasLink && !$hasFile ? '' : 'display:none;' }}">
                                            ...
                                            <input type="text" name="book_link" class="form-control" value="{{ $data->book_link }}" placeholder="https://example.com/file.pdf">
                                        </div>
                                    </div>
