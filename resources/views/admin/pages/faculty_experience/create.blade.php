...
@section('title', 'Add Faculty Experience')
@section('content')
            ...
            <div class="row page-titles mx-0">
                ...
                <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="javascript:void(0);">Add Faculty Experience</a></li>
                    </ol>
                </div>
            </div>
                ...
                <div class="col-xl-12 col-xxl-12 col-sm-12">
                    ...
                    <div class="card">
                        <div class="card-header justify-content-start">
                            <h5 class="card-title me-3">Add Faculty Experience</h5> 
                            <a href="{{ url('/vtadmin/list-faculty-experience') }}" class="btn btn-primary"><i class="fa-solid fa-angles-left"></i> Back</a>
                        </div>
                        <div class="card-body">
                            <form action="{{ url('/vtadmin/addFacultyExperience') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-sm-4">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-hasicon mb-xl-0 mb-3">
                                                <input type="type" name="faculty_experience" placeholder="Enter Faculty Experience" class="form-control" value="{{ old('faculty_experience') }}" required="">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="mb-3">
