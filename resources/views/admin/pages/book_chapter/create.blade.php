...
@section('title', 'Add Faculty Book Chapter')
@section('content')
            ...
            <div class="row page-titles mx-0">
                <div class="col-sm-6 p-md-0">
                    <div class="welcome-text">
                        <h4>Add Faculty Book Chapter</h4>
                    </div>
                </div>
                ...
                <div class="col-xl-12 col-xxl-12 col-sm-12">
                    ...
                    <div class="card">
                        <div class="card-header justify-content-start">
                            <h5 class="card-title me-3">Add Faculty Book Chapter</h5>
                            <a href="{{ url('/vtadmin/list-chapter') }}" class="btn btn-primary"><i class="fa-solid fa-angles-left"></i> Back</a>
                        </div>
                        <div class="card-body">
                            <form action="{{ url('/vtadmin/addChapter') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-sm-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-hasicon mb-xl-0 mb-3">
                                                <input type="text" name="paper_title"
                                                    ...
                                                    value="{{ old('paper_title') }}" required="">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-hasicon mb-xl-0 mb-3">
                                                <input type="text" name="chapter_name" placeholder="Enter Book Chapter Name"
                                                    class="form-control" value="{{ old('chapter_name') }}" required="">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-hasicon mb-xl-0 mb-3">
                                                <!--<input type="year" name="publications_date" class="datepicker-default form-control" id="datepicker" value="{{ old('publications_date') }}" required="">-->
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input id="isbn_no" name="isbn_no" placeholder="Enter ISBN No."
                                                type="text" class="form-control" value="{{ old('isbn_no') }}"
                                                required="">
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input id="paper_link" name="paper_link" placeholder="Enter Link of the Paper"
                                                type="text" class="form-control" value="{{ old('paper_link') }}"
                                                required="">
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <div class="mb-3" id="fileBox">
                                            ...
                                            <input type="file" name="chapter_file" class="form-control">
                                        </div>
                                        <!-- Link Input Box -->
                                        <div class="mb-3" id="linkBox" style="display: none;">
                                            <label class="form-label">Enter URL Link</label>
                                            <input type="text" name="chapter_link" class="form-control"
                                                value="{{ old('chapter_link') }}"
