            ...
            <div class="col-xl-8 col-xxl-8 col-sm-12">
                ...
                <div class="card">
                    <div class="card-header justify-content-start">
                        <h5 class="card-title me-3">Edit Faculty</h5>
                        <a href="{{ url('/vtadmin/list-faculty') }}" class="btn btn-primary"><i class="fa-solid fa-angles-left"></i> Back</a>
                    </div>
                    <div class="card-body">
                        <form action="{{ url("/vtadmin/editFaculty",$data->id) }}" method="post">
                            @csrf
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label class="form-label" for="faculty_name">Enter Faculty Title</label>
                                        <input type="text" name="faculty_name" id="faculty_name" placeholder="Enter Faculty Name" value="{{ $data->faculty_name }}" class="form-control" required>
                                    </div>
                                </div>
                                <div class="mb-3">
                                </div> 
