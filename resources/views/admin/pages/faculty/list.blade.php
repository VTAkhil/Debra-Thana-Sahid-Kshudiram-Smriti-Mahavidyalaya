            ...
            <div class="row page-titles mx-0">
                ...
                <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="javascript:void(0);">All Faculty</a></li>
                    </ol>
                </div>
            </div>
            <div class="row">
                        ...
                        <div class="tab-pane fade active show col-lg-12">
                            <div class="card">
                                <div class="card-header justify-content-start">
                                    <h4 class="card-title me-2">All Faculty List </h4>
                                    <a href="{{ url('/vtadmin/add-faculty') }}" class="btn btn-primary"><i class="fa-solid fa-plus"></i> Add new</a>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="example3" class="table ">
                                            ...
                                            <tbody>
                                                <?php $faculties = DB::table('faculties')->where("status", "!=", "2")->orderBy("id","desc")->paginate(10);
                                                ...
                                                <tr>
                                                        ...
                                                        <div class="tab-pane active" id="kt_builder_toolbar">
                                                            <div class="row">
                                                                <div class="col-lg-3 col-xl-9">
                                                                   <form action="{{ url('/vtadmin/FacultyStatusChanger/' . $faculty->id) }}" id="sstc{{ $faculty->id }}" method="POST">
                                                                    @csrf
                                                                        <div class="form-check form-check-custom form-check-solid form-switch mt-2"> 
                                                                            <input class="form-check-input" type="checkbox" id="status{{ $faculty->id }}" {{ $faculty->status == 1 ? 'checked' : '' }} onchange="statusActivInact('{{ $faculty->id }}');">
                                                                        </div>
                                                                    </form>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <td>
                                                        <a href="{{ url('vtadmin/edit-faculty', $faculty->id) }}" class="btn btn-xs sharp btn-primary"><i class="fa fa-pencil"></i></a>
                                                        <a href="{{ url('vtadmin/deleteFaculty', $faculty->id) }}" class="btn btn-xs sharp btn-danger"><i class="fa fa-trash"></i></a>
                                                    </td>
                                                </tr>
                                                <?php
                                                $i++;
