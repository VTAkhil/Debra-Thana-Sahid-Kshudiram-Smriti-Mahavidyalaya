            ...
            <div class="col-xl-12 col-xxl-12 col-sm-12">
                ...
                <div class="card">
                    <div class="card-header justify-content-start">
                        <h5 class="card-title me-3">Add Notice</h5>
                        <a href="{{ url('/vtadmin/list-notice') }}" class="btn btn-primary"><i class="fa-solid fa-angles-left"></i> Back</a>
                    </div>
                    <div class="card-body">
                        <form action="{{ url("/vtadmin/addNotice") }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label class="form-label" for="Enter_First_Name">Enter Title</label>
                                        <input id="Enter_First_Name" name="notice_title" placeholder="Enter Title" type="text" class="form-control" value="{{ old('notice_title') }}" required="">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-hasicon mb-xl-0 mb-3">
                                            <!--<input type="date" name="start_date" class="datepicker-default form-control" id="datepicker" value="{{ old('start_date') }}" required="">-->
                                            <input class="form-control mb-xl-0 mb-3 bt-datepicker" value="{{ old('start_date') }}" type="text" id="datepicker" name="start_date" required>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-hasicon mb-xl-0 mb-3">
                                            <!--<input type="date" name="end_date" class="datepicker-default form-control" id="datepicker" value="{{ old('end_date') }}" required="">-->
                                            <input class="form-control mb-xl-0 mb-3 bt-datepicker" value="{{ old('end_date') }}" type="text" id="datepicker" name="end_date" required>
                                            <div class="icon"><i class="far fa-calendar"></i></div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="mb-3" id="linkBox" style="display: none;">
                                        ...
                                        <input type="text" name="notice_link" class="form-control" value="{{ old('notice_link') }}" placeholder="https://example.com/file.pdf">
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="notice_value">
                                            ...
                                            <option value="Examination Notifications">Examination Notifications</option>
