        ...
        <div class="row page-titles mx-0">
            ...
            <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="javascript:void(0);">Upload Achivement/a></li>
                </ol>
            </div>
        </div>
                        ...
                        <form action="{{ url("/vtadmin/addAchivement") }}" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input id="Enter_First_Name" name="student_number" placeholder="Enter No. of Students" type="text" class="form-control" value="{{ old('student_number') }}" required="">
                                </div>

                                <div class="col-lg-6">
                                    <label class="form-label">Enter Type of Assistance</label>
                                    <input id="Enter_First_Name" name="type_assistance" placeholder="Enter Type of Assistance" type="text" class="form-control" value="{{ old('type_assistance') }}" required="">
                                </div>
