        ...
        <div class="row page-titles mx-0">
            <div class="col-sm-6 p-md-0">
                <div class="welcome-text">
                    <h4>Upload Seminar</h4>
                </div>
            </div>
            <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ url('/vtadmin/dashboard') }}">Home</a></li>
                    <li class="breadcrumb-item"><a href="{{ url('/vtadmin/upseminer') }}">Seminar</a></li>
                    <li class="breadcrumb-item active"><a href="javascript:void(0);">Upload Seminar</a></li>
                </ol>
            </div>
        </div>
        <div class="row">
            <div class="col-xl-12 col-xxl-12 col-sm-12">
                ...
                <div class="card">
                    <div class="card-header justify-content-start">
                        <h5 class="card-title me-3">Upload Seminar</h5>
                        <a href="{{ url('/vtadmin/upseminar-list') }}" class="btn btn-primary"><i class="fa-solid fa-angles-left"></i> Back</a>
                    </div>
                    <div class="card-body">
                        <form action="{{ url("/vtadmin/addUpSeminar") }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label class="form-label" for="Enter_First_Name">Enter Title of the Seminar / Webinar / Workshop / Events / Conferences</label>
                                        <input id="Enter_First_Name" name="seminar_titile" placeholder="Enter the Seminar Titile" type="text" class="form-control" value="{{ old('notice_title') }}" required="">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                 ...
                                 <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input id="Enter_First_Name" name="speakers_name" placeholder="Enter Speakers" type="text" class="form-control" value="{{ old('notice_title') }}" required="">
                                    </div>
                                </div>
                                 <div class="col-sm-6">
                                    <div class="form-group">
                                        <label class="form-label" for="Enter_First_Name">Enter Duration</label>
                                        <input id="Enter_First_Name" name="enter_duration" placeholder="Enter Duration" type="text" class="form-control" value="{{ old('notice_title') }}" required="">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="mb-3" id="linkBox" style="display: none;">
                                        ...
                                        <input type="text" name="seminar_link" class="form-control" value="{{ old('notice_link') }}" placeholder="https://example.com/file.pdf">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label class="form-label" for="datepicker">Select Date</label>
											<div class="input-hasicon mb-xl-0 mb-3">
												<input class="form-control mb-xl-0 mb-3 bt-datepicker" name="seminar_date" type="text" id="datepicker" >
