                ...
                <div class="col-xl-12 col-xxl-12 col-sm-12">
                    ...
                    <div class="card">
                        <div class="card-header justify-content-start">
                            <h5 class="card-title me-3">Edit Routine</h5>
                            <a href="{{ url('/vtadmin/list-routine') }}" class="btn btn-primary"><i
                                    class="fa-solid fa-angles-left"></i> Back</a>
                        </div>
                        <div class="card-body">
                            <form action="{{ url('/vtadmin/editRoutine', $data->id) }}" method="post"
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input id="Enter_First_Name" name="routine_title" placeholder="Enter Title" type="text" class="form-control" value="{{ $data->routine_title }}" required="">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-hasicon mb-xl-0 mb-3">
                                                <!--<input type="date" name="routine_date" class="datepicker-default form-control" id="datepicker" value="{{ $data->routine_date }}" required="">-->
                                                <input class="form-control mb-xl-0 mb-3 bt-datepicker" value="{{ old('routine_date') }}" type="text" id="datepicker" name="routine_date">
                                    ...
                                    @php
                                        $hasFile = !empty($data->routine_file);
                                        $hasLink = !empty($data->routine_link);
                                    @endphp
                                    <div class="col-sm-6">
                                        <!-- File Upload Box -->
                                        <div class="mb-3" id="fileBox" style="{{ $hasFile ? '' : 'display:none;' }}">
                                            ...
                                            @php
                                                $ext = strtolower(pathinfo($data->routine_file, PATHINFO_EXTENSION));
                                            @endphp
                                            @if (in_array($ext, ['jpg', 'jpeg', 'png', 'webp']))
                                                <img src="{{ url('/public/uploads/routine/' . $data->routine_file) }}" style="width:80px;height:80px">
                                            @elseif ($ext === 'pdf')
                                                <a href="{{ url('/public/uploads/routine/' . $data->routine_file) }}" class="btn btn-sm btn-primary" download>
                                        ...
                                        <div class="mb-3" id="linkBox" style="{{ $hasLink && !$hasFile ? '' : 'display:none;' }}">
                                            ...
                                            <input type="text" name="routine_link" class="form-control" value="{{ $data->routine_link }}" placeholder="https://example.com/file.pdf">
                                        </div>
                                    </div>
