            ...
            <div class="row page-titles mx-0">
                ...
                <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ url('/vtadmin/list-faculty-assign') }}">Faculty Assign</a>
                        </li>
            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-xl-12 col-xxl-12 col-sm-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ url('/vtadmin/editFacultyAssign', $data->id) }}" method="post"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            @php
                                                $subjects = DB::table('subjects')->where('id', $data->subject_id)->first();
                                            @endphp
                                            <input type="text" id="subject_name" class="form-control" readonly value="{{ $subjects->subject }}">
                                    ...
                                    <script>
                                        $("#faculty_id").change(function() {
                                            ...
                                            if (!faculty) return; // prevent empty overwrite
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-hasicon mb-xl-0 mb-3">
                                                <input type="text" name="faculty_new_designation"
                                                    ...
                                                    value="{{ $data->faculty_new_designation }}" required="">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="another_subject_id">
                                                <option selected disabled>Select Department</option>
                                                <?php $subjects = DB::table('subjects')->where('status', '1')->orderBy('id', 'Desc')->get(); ?>
                                                @foreach ($subjects as $subject)
                                                    <option value="{{ $subject->id }}" @selected($subject->id == $data->another_subject_id)>
