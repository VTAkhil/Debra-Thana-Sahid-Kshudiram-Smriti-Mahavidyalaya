            ...
            <div class="row">
                <div class="col-xl-12 col-xxl-12 col-sm-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ url("/vtadmin/editGallery", $data->id) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label class="form-label" for="gallery_title">Enter Gallery Title</label>
                                            <input id="gallery_title" name="gallery_title" placeholder="Enter Gallery Title" type="text" class="form-control" value="{{ $data->gallery_title }}" required="">
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                     ...
                                     <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="file" name="gallery_image" class="form-control" value="{{ $data->gallery_image }}" accept="image/png,image/jpeg,image/jpg">
                                            <img src="{{ url('/public/uploads/gallery/' . $data->gallery_image) }}"style="width:80px;height:80px">
                                        </div>
                                    </div>
