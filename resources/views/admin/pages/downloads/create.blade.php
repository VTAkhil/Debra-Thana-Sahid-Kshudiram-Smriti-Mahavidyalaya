            ...
            <div class="col-xl-12 col-xxl-12 col-sm-12">
                ...
                <div class="card">
                    <div class="card-header justify-content-start">
                        <h5 class="card-title me-3">Add Download</h5>
                        <a href="{{ url('/vtadmin/list-download') }}" class="btn btn-primary"><i class="fa-solid fa-angles-left"></i> Back</a>
                    </div>
                    <div class="card-body">
                        <form action="{{ url("/vtadmin/addDownload") }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label class="form-label" for="Enter_First_Name">Enter Title</label>
                                        <input id="Enter_First_Name" name="download_title" placeholder="Enter Title" type="text" class="form-control" value="{{ old('download_title') }}" required="">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-hasicon mb-xl-0 mb-3">
                                            <input class="form-control mb-xl-0 mb-3 bt-datepicker" value="{{ old('download_date') }}" type="text" id="datepicker" name="download_date" required>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="mb-3" id="linkBox" style="display: none;">
                                        ...
                                        <input type="text" name="download_link" class="form-control" value="{{ old('download_link') }}" placeholder="https://example.com/file.pdf">
                                    </div>
                                </div>
