        ...
        <div class="row align-items-center justify-content-center">
            <div class="col-xl-12 col-xxl-12 col-sm-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ url("/vtadmin/addPlacementProgression") }}" method="post">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input id="Enter_First_Name" name="student_name" placeholder="Enter Student Name" type="text" class="form-control" value="{{ old('student_name') }}" required="">
                                </div>
                                <div class="col-lg-6">
                                    <label class="form-label">Enter Year</label>
                                    <input id="Enter_First_Name" name="year" placeholder="Enter Year" type="text" class="form-control" value="{{ old('year') }}" required="">
                                </div>
                                <div class="col-lg-6">
                                    <label class="form-label">Enter Placement / Progression</label>
                                    <input id="Enter_First_Name" name="placement_progression" placeholder="Enter Placement / Progression" type="text" class="form-control" value="{{ old('placement_progression') }}" required="">
                                </div>
                                <div class="mb-3"></div>
